...
> **확인 시점:** 2026-09-03<br>
> **HWP 표 2 수정 시각:** 2026-09-03 01:06<br>
...
|  | 완전 분리¹ | 0.00%p |
|  | 사슬형² | +3.22~4.27%p |
| 환자 제약 (80개 설정) | 새 검사 | 21→0회 |
|  | 추가 방문 | 56→0회 |
|  | 미정 시험 평균 | 0.88→1.24건 |

¹ 영향 우선−무작위 선택. ² 조합 탐색−영향 우선. 영향 우선과 무작위 순서 평균의
차이는 +5.73%p(95% 구간 +3.04~+8.55%p)였다. 답 분포 기반 방법과 영향 우선의
차이는 +2.00%p(95% 구간 -2.00~+6.50%p)로 뚜렷하지 않았다.
