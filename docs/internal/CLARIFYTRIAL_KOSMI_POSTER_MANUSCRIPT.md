...
> **확인 시점:** 2026-09-03<br>
> **HWP 본문·표 수정 시각:** 2026-09-03 02:17<br>
...
방식은 먼저 연결된 미정 시험 수, 다음으로 조건 수를 비교하고, 같으면 환자 부담이 적은
정보를 골랐다. 답 분포 기반 방식은 개발용 합성 환자에서 각 답이 나온 비율을 이용해,
다음 질문 뒤 정리될 시험 수가 가장 클 것으로 예상되는 정보를 골랐다. 조합 탐색은 남은
확인 횟수 안에서 가능한 정보 조합을 모두 따져, 정리할 수 있는 시험이 가장 많은 순서를
골랐다. 무작위 기준은 숨긴 정보 5개의 120가지 순서를 모두 실행해 구한 평균이다.

정보 공유 실험에서는 한 정보가 여러 시험에 함께 쓰이는 경우, 서로 분리된 경우,
사슬처럼 이어진 경우를 나눠 질문 순서의 효과를 살폈다. 환자 부담 실험에서는 새 검사와
추가 방문을 모두 허용한 경우와 제한한 경우를 같은 사례에서 비교했다.
