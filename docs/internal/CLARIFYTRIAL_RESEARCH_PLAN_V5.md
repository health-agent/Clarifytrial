...
| 환자 맞춤 추가 부담 | 자료형·360회 비교·채택 기준 설계 완료, 구현 전 |
...
10. 다음 — 새 검사·침습 절차·치료 변경의 사람 승인 경계와 보류 검사
11. 다음 — 기존 30명에 부담 조건을 짝으로 붙인 360회 비교 실행
12. 다음 — 공개 원문과 환자 문장을 구조화하는 모델 정확도 평가
13. 다음 — 후보 검색부터 질문·답변·재판정까지 자연어 전체 실행 연결
14. 후속 — 숫자·기간 조건의 near-miss 보조 분석
15. 가능하면 코디네이터 또는 임상의 소규모 비교
