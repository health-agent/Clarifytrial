...
| 질문 순서 결과 | 세 번 확인한 뒤 최종 답과 같아진 시험: 고정 순서 75%, 현재 방식 89% |
...
- 관련 시험 검색: 정답 시험을 후보 안에 남긴 비율과 앞쪽에 둔 정도
...
| ClarifyTrial v5 | 코드가 정보·확인 방법을 고르고 언어모델은 조건 해석과 문장 작성을 담당 | 현재 방식 |
...
복잡한 계산은 30명 고정 평가에서 가장 강한 단순 정책보다 시험 상태 회복을 5퍼센트포인트
...
13. 완료 — 여러 시험의 모델 판단, 환자 맞춤 확인 방법, 다시 판단과 두 추천 목록 연결
