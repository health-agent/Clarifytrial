...
16. 후속 — 숫자·기간 조건의 near-miss 보조 분석
17. 가능하면 코디네이터 또는 임상의 소규모 비교
...
최종 평가는 새 공개 시험 15건과 새 합성 기본 환자 30명으로 만든다. 기본 환자마다
임상값은 같지만 근거가 충분한 경우와 오래됐거나 확인되지 않은 경우를 하나씩 만들어
총 60회를 평가한다. 이 짝에서는 후보 유지 정답은 같고 현재 확인 정답만 달라져야 한다.
