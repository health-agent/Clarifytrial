...
| ClarifyTrial v5 | 후보 유지와 현재 확인을 나눠 사실·경로를 선택 | 제안 방식 |
...
첫 clarification policy는 숨은 답을 보지 않고 현재 상태표와 조건 연결만 사용한다.
다음 순서로 사실 하나를 고른다.

1. 현재 미해결 후보 시험을 더 많이 해결하는 사실
2. 더 많은 미해결 조건을 줄이는 사실
3. 영향이 같으면 환자 질문, 기록 조회, 별도 확인 순으로 부담이 낮은 경로

모델은 선택된 사실에 대한 자연어 질문이나 확인 요청문을 작성한다. 질문 문장보다
