"""Run the heldout common-facts-known supplemental policy evaluation."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("runs/public-protocol-common-facts-known-v1"),
    )
    args = parser.parse_args()
    summary = run_public_protocol_common_facts_known(
