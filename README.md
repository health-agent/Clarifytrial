...
589건 검색에서 평가 대상 150건은 모두 상위 200개 안에 들어왔다. 평균 순위는 37.3위,
가장 낮은 순위는 123위였다. 평가 시험 50건은 같은 시험 모음에서 고른 대상이므로 이
수치를 다른 질환과 환자에 대한 검색 일반화 성능으로 해석하지 않는다. TREC 공개자료의
...
언어모델은 자유 형식 기록을 정해진 환자 사실로 옮기고, 복잡한 시험 조건을 읽어
조건별 판단 이유와 질문 문장을 만든다. 코드가 다음 일을 맡는다.
