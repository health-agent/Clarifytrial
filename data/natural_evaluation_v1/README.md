...
| `preliminary_natural_records.json` | 같은 60회를 진료기록형·문장형으로 표현한 합성 기록 |
...
이 30명으로 질문 규칙의 약점을 확인하고 v3를 만들었으므로 현재는 개발 자료로만
취급한다. 최종 규칙을 정한 뒤 만든 새 합성 환자는 `data/natural_evaluation_v2`에
있다.
